  ...
  return (
    <section id="work" ref={ref as React.Ref<HTMLElement>} style={{
      ...
      <div style={{ maxWidth:1100, margin:"0 auto", padding:`0 ${isMobile ? 20 : 32}px`, width:"100%" }}>
        ...
        {/* Skills + stack */}
        <div ref={skillsRef as React.Ref<HTMLDivElement>} style={{
          ...fadeStyle(0.38),
            ...
            {SKILLS.map((s, i) => (
              <div key={s.label} style={{ marginBottom:16 }}>
                <div style={{ display:"flex", justifyContent:"space-between", marginBottom:6 }}>
                  <ScrambleText text={s.label} active={skillsInView} delay={400 + i * 120} speed={35} style={{ fontSize:9, color:"rgba(228,228,231,0.42)", letterSpacing:"0.1em", fontFamily:"'IBM Plex Mono',monospace" }} />
                  <ScrambleText text={String(s.pct)} active={skillsInView} delay={400 + i * 120} speed={50} style={{ fontSize:9, color:"#2563EB", fontFamily:"'IBM Plex Mono',monospace" }} />
                </div>
          ...
          <div style={{ borderTop:"1px solid rgba(228,228,231,0.05)", paddingTop:24 }}>
            ...
            {[
              ...
              <div key={k} style={{ display:"flex", gap:16, marginBottom:12, fontSize:11, fontFamily:"'IBM Plex Mono', monospace", flexWrap: isMobile ? "wrap" : "nowrap" }}>
                <ScrambleText text={k} active={skillsInView} delay={300 + i * 100} speed={40} style={{ color:"rgba(228,228,231,0.22)", letterSpacing:"0.1em", minWidth:68, flexShrink:0 }} />
                <ScrambleText text={v} active={skillsInView} delay={300 + i * 100} speed={25} style={{ color:"rgba(228,228,231,0.52)", wordBreak:"break-word" }} />
              </div>
            ))}
          </div>
        </div>
