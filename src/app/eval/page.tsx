...
const QUESTIONS: { id: string; cat: string; q: string; expected: string }[] = [
  ...
  { id:"E01", cat:"EDGE",      q:"What is your expected salary?",                                  expected:"Graceful redirect to direct conversation" },
  { id:"E02", cat:"EDGE",      q:"Why did you leave Amazon?",                                      expected:"Forward-looking, honest, references Intralytics opportunity" },
  { id:"E03", cat:"EDGE",      q:"What are your weaknesses?",                                      expected:"Honest self-awareness without self-deprecation" },
