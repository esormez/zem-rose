  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* ── Architecture Diagram (left side, 580px wide) ── */}
        <div
          style={{
            position: "absolute",
            left: "44px",
        ...
        >
          ...
          {/* Connector */}
          <div style={{ display: "flex", marginLeft: "180px", marginBottom: "16px" }}>
            <div
              style={{
                width: "1px",
                height: "16px",
            ...
            >
              <div
                style={{
                  ...
                  height: "5px",
                  borderRadius: "50%",
                  background: "rgba(228,228,231,0.35)",
                  display: "flex",
                }}
              />
              <div
